...
export default function EssencePage() {
  ...
  return (
    <div className="min-h-screen bg-surface pt-24">
      ...
      <section className="py-24 px-6 md:px-12">
        <div className="max-w-5xl mx-auto text-center">
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-accent uppercase tracking-[0.5em] text-[10px] mb-6"
          >
            Our Philosophy
          </motion.p>
          <motion.h1
            ...
            className="text-foreground text-5xl md:text-7xl font-serif italic mb-8"
          >
          ...
          <motion.p
            ...
            className="text-muted text-sm md:text-base leading-loose max-w-2xl mx-auto"
          >
      ...
      {/* Story Section */}
      <section className="py-20 px-6 md:px-12 border-t border-foreground/5">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            <p className="text-accent text-[9px] uppercase tracking-[0.5em] mb-4">Our Story</p>
            <h2 className="text-foreground text-3xl md:text-4xl font-serif italic mb-6">
              Handmade with Heart
            </h2>
            <p className="text-muted text-sm leading-loose mb-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="aspect-[3/4] bg-dim overflow-hidden"
          >
            <div className="w-full h-full bg-gradient-to-br from-accent/10 to-transparent flex items-center justify-center">
              <p className="text-accent text-6xl font-serif italic opacity-20">L</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 md:px-12 border-t border-foreground/5">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-accent text-[9px] uppercase tracking-[0.5em] mb-4">What We Stand For</p>
            <h2 className="text-foreground text-3xl md:text-4xl font-serif italic">Our Values</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              >
                ...
                <h3 className="text-foreground text-lg font-serif italic mb-4">{value.title}</h3>
                <p className="text-subtle text-sm leading-loose">{value.description}</p>
              </motion.div>
            ))}
          </div>
        </div>

  ...
  return (
    <div className={`relative ${offset ? 'md:mt-32' : ''}`}>
      ...
      <div className="mt-8">
        ...
        <div className="h-5 w-40 bg-dim animate-pulse rounded" />
      </div>
    </div>
  );
}
    ...
    <section className="bg-surface py-24 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16">
          ...
          <h2 className="text-foreground text-5xl md:text-7xl font-serif italic">Our Gallery</h2>
        </div>
          ...
          {loading ? (
            ...
            >
              ...
              <div className="mt-8">
                ...
                <h3 className="text-foreground text-2xl font-serif tracking-tight">
                  {product.name}
                </h3>
                {product.price && (
                  <div className="mt-2">
            ...
            <p className="text-subtle">No products found in database.</p>
          )}
        </div>
